...
public class SCSS3Exception extends SCSServiceException {
    ...
    /**
     * Constructs a new {@link SCSS3Exception} with the specified message.
     *
     * @param message
     *            The error message describing why this exception was thrown.
     *
     * @see SCSS3Exception#AmazonS3Exception(String, Exception)
     */
    public SCSS3Exception(String message) {
        super(message);
    }

    /**
     * Constructs a new {@link SCSS3Exception} with the specified message and root
     * cause.
     *
     * @param message
     *            The error message describing why this exception was thrown.
     ...
     *
     * @see SCSS3Exception#AmazonS3Exception(String)
     */
    public SCSS3Exception(String message, Exception cause) {
        super(message, cause);
    }
     ...
     *
     * @see SCSS3Exception#setExtendedRequestId(String)
     */
     ...
     *
     * @see SCSS3Exception#getExtendedRequestId()
     */
