...
import com.sinacloud.scs.services.scs.model.StorageClass;
...
public class UploadCallable implements Callable<UploadResult> {
     ...
     */
    @Deprecated
    public UploadCallable(TransferManager transferManager, ExecutorService threadPool, UploadImpl upload, PutObjectRequest putObjectRequest, com.sinacloud.scs.services.scs.transfer.internal.ProgressListenerChain progressListenerChain) {
    ...
    private UploadResult uploadInParts() throws Exception {
        ...
        boolean isUsingEncryption = false;//s3 instanceof AmazonS3EncryptionClient;
        ...
        try {
            ...
            if (TransferManagerUtils.isUploadParallelizable(putObjectRequest, isUsingEncryption)) {
                ...
                UploadResult uploadResult = uploadPartsInSeries(requestFactory);
