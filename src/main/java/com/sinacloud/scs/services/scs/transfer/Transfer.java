...
public interface Transfer {
     ...
     */
    @Deprecated
    public void addProgressListener(com.sinacloud.scs.services.scs.model.ProgressListener listener);

    /**
     * @deprecated Replaced by {@link #removeProgressListener(ProgressListener)}
     */
    @Deprecated
    public void removeProgressListener(com.sinacloud.scs.services.scs.model.ProgressListener listener);
}
