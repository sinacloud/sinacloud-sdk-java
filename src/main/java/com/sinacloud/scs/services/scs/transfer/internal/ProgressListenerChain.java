...
import com.sinacloud.scs.services.scs.model.ProgressEvent;
...
public class ProgressListenerChain implements ProgressListener {
    ...
    public com.sinacloud.scs.event.ProgressListenerChain transformToGeneralProgressListenerChain() {
        com.sinacloud.scs.event.ProgressListenerChain newProgressListenerChain = new com.sinacloud.scs.event.ProgressListenerChain();
        for ( ProgressListener listener : listeners ) {
